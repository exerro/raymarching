...
//        )
    ...
    display.attachLoadCallback {
        ...
        font = loadFontFromInputStream(ShaderCompilation::class.java.getResourceAsStream("/font/open-sans/OpenSans-Regular.fnt")!!, "open sans font idk") {
            loadTextureFromInputStream(ShaderCompilation::class.java.getResourceAsStream(it)!!, it)
        }
    }
